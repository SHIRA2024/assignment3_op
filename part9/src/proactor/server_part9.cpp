...
/**
 * @brief Thread function that handles a single client (Proactor style).
 */
void* handleClient(void* arg) {
...
/**
 * @brief Main function that starts the Proactor-based server.
 */
int main() {
    ...
    std::cout << "Proactor-based threaded server running on port " << PORT << "...\n";
    ...
    while (true) {
        ...
        *clientSocket = accept(serverSocket, (struct sockaddr*)&clientAddr, &addrSize);
        ...
        pthread_t t = startProactor((void*)clientSocket, handleClient);
        (void)t; // משתיק אזהרת unused
